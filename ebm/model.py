...
def run_model(T_ini=ORIGINAL_T_ini, solar=ORIGINAL_solar, alpha=ORIGINAL_alpha, eps=ORIGINAL_eps, sigma=ORIGINAL_sigma, H=ORIGINAL_H, maxtime=ORIGINAL_maxtime, dt=ORIGINAL_dt, ce=ORIGINAL_ce, cp=ORIGINAL_cp):
